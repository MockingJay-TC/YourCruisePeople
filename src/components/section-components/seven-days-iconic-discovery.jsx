...
class SevenDaysIconicDiscovery extends Component {
  render() {
                ...
                <div className="col-lg-4 col-md-6">
                  <div className="single-trip-plan">
                    <div className="thumb single-trip-plan-left">
                      <img
                        src={publicUrl + "assets/img/others/6.png"}
                        alt="blog"
                      />
                    </div>
                ...
                <div className="single-destination-grid text-center">
                  ...
                  <div className="details">
                    ...
                    <p className="content">
                      ...
                      covers 6% Earth's total surface area and 20% land area.
                    </p>
...
export default SevenDaysIconicDiscovery;
